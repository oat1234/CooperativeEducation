package com.finalproject.cooperativeeducation.database;
...
public class MyDatabase extends SQLiteOpenHelper{
	...
	public static String DB_TABLE_Admin = "TABLE_Admin"; //สร้างชื่อตาราง
	public static String DB_TABLE_User = "TABLE_User";
	public static String DB_TABLE_Student = "TABLE_Student";
	public static String DB_TABLE_Instructor = "TABLE_Instructor";
	public static String DB_TABLE_Company = "TABLE_Company";
	public static String DB_TABLE_Chat = "TABLE_Chat";
	...
	String SQL_TABLE_ONE = "CREATE TABLE "+DB_TABLE_Admin+"("+DB_FEILD_ID+" integer primary key autoincrement, "+
